jQuery(document).ready(function() {
  ...
  toolbar_items_size: 	'small',
	...
	function addTable(){
		...
		jQuery('body').on('change','#ReportTable_'+itemCounter+'_table_id', selectTable);
	}
	...
	{
		jQuery(this+' option[value='+jQuery(this).val()+']').attr("selected",true); 
		//console.log(this.tagName+jQuery(this).val());
		jQuery.ajax(
				{
				'type': 'POST',
				...
				'success' :	
					function(html)
					{
						...
						var lay = jQuery(this).parents().get(0);
						jQuery()
